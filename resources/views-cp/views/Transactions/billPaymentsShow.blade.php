                ...
                <div class="card shadow-sm rounded">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between my-3">
                            ...
                            <p class="text-muted mb-0">{{ $transactions->transaction->transaction_date }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card shadow-sm rounded">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between my-3">
                            ...
                            <p class="text-danger mb-0">{{ $transactions->billerItem->category->category ?? 'N/A' }}</p>
                        </div>
                        <div class="d-flex justify-content-between my-3">
                            <p class="mb-0"><strong>Type:</strong></p>
                            <p class="text-muted mb-0">{{ $transactions->billerItem->paymentitemname ?? 'N/A' }}</p>
                        </div>
                        <div class="d-flex justify-content-between my-3">
                        ...
                        <div class="d-flex justify-content-between my-3">
                            ...
                            <p class="text-muted mb-0">{{ $transactions->transaction->amount ?? 'N/A' }}</p>
                        </div>
                        <div class="d-flex justify-content-between my-3">
                            <p class="mb-0"><strong>Charge:</strong></p>
                            <p class="text-danger mb-0">{{ $transactions->billerItem->itemFee ?? 'N/A' }}</p>
                        </div>
                        <div class="d-flex justify-content-between my-3">
