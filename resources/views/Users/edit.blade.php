            ...
            <div class="card-body ">
                ...
                <div class="table-responsive">
                    <form action="{{route('user.update',$user->id)}}" method="POST" class="overflow-hidden">
                        ...
                        @else
                        <img src="{{ asset($user->account->profile_picture) }}" class="my-3" alt="User"
                            width="150px" height="150px">
                        @endif
                        ...
                        <div class="mb-3 row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="firstName" value="{{ $user->account->firstName ?? '' }}"
                                    id="" class="form-control">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="">Last Name</label>
                                <input type="text" name="lastName" value="{{ $user->account->lastName ?? '' }}"
                                    id="" class="form-control">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="phone" value="{{ $user->account->phone ?? '' }}"
                                    id="" class="form-control">
                            </div>
                        </div>
                        <div class="mb-3 row">
