...
@section('main')
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        ...
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            ...
            <a href="{{route('social.media.create')}}" class="btn btn-primary mb-2 mb-md-0" >Add Socail Media</a>
        </div>
    </div>
    <div class="row">
        <div class="card">
                        ...
                        <tbody>
                            @foreach ($socialMedia as $item)
                                <tr>
                                    ...
                                    @else
                                        <img src="{{ asset('assets/images/others/dummyImage.jpg') }}" alt="">                                     
                                    @endif
                                    

                                    </td>
                                    <td>
                                        <a href="{{route('social.media.edit',$item->id)}}" class="btn btn-outline-primary">Edit</a>
                                        <a href="{{route('social.media.delete',$item->id)}}" class="btn btn-outline-secondary mx-2">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
