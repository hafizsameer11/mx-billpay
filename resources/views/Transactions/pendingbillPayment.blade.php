...
@section('main')
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Pending Bill Payments</h4>
        </div>
    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Pending Bill Payments</h6>
                <div class="row d-flex justify-content-between mb-4">
                    <form method="GET" action="{{ route('pending.billPayments.transactions') }}">
                        <div class="row">
                            <div class="col-md-8">
